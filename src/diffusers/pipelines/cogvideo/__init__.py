...
try:
    ...
    _import_structure["pipeline_cogvideox_frames2video"] = ["CogVideoXFramesToVideoPipeline"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_cogvideox_frames2video import CogVideoXFramesToVideoPipeline
